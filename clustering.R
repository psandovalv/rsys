...
CorrelationClusters <- function(mat, kmin=0, kmax=10, min.corr=0.4) {
  ## Return a group of highly correlated symbols

  ## mat is the correlation matrix
  ## kmin is the minimum number of elements in the cluster
  ## kmax is the maximum number of elements in the cluster
  ## min.corr is the minimum correlation for any symbol to be accepted
